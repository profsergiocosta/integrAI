...
from apps.gestantes.views import index, lista_gestantes, gestante, buscar, nova_gestante, deletar_gestante, editar_gestante, avaliacao, detalhes_risco, chat, evolucao_riscos_gestante
